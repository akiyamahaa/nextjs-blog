...
const Home = async () => {
  ...
  return (
    <Layout>
        ...
        {popularTopics?.enable && (
          <section className="sm:pt-5 pb-16 sm:pb-24 overflow-hidden">
            <div className="container mt-12">
              ...
              <ul className="text-center flex flex-wrap justify-center gap-x-3 gap-y-4 sm:gap-6 lg:gap-8 [&>li]:text-2xl sm:[&>li]:text-3xl lg:[&>li]:text-4xl [&>li]:cursor-pointer font-primary text-text [&>li]:capitalize">
      ...
      {/* Popular Articles */}
      <div className="bg-home2sm md:bg-home2md lg:bg-home2 bg-center bg-cover">
      ...
      <div className="bg-home3sm md:bg-home3md lg:bg-home3 bg-center bg-cover">
        {/* Trending Articles */}
        {trendingArticles?.enable && trendingPosts.length > 0 && (
          <section className="pt-16 sm:pt-24 pb-6 sm:pb-12">
            <div className="container">
              ...
              <div className="container">
                <div className="border-t pt-8 border-[#627669]">
                  <div className="sm:flex justify-between">
                    <h2 className="text-base uppercase font-secondary pl-4 relative after:absolute after:rounded-full -mt-1 after:content-[''] after:h-2 after:w-2 after:bg-primary after:left-0 after:top-2 text-text w-fit mx-auto sm:mx-0 mb-10 sm:mb-0">
                      {postOfTheWeekSection?.title}
                    </h2>

                    <Link
                      className="button group animate-top-right button-black w-fit hidden sm:flex"
              ...
              <div className="container mt-8">
                <article className="row g-4 lg:g-6 items-center">
                  <div className="md:col-6">
                    <div className="post-card post-category-top group relative has-line-link-white">
                      <div className="relative">
                        <span className="post-category text-white bg-sameLight2 z-10">
                          <Link
                            href={`/category/${slugify(
                              postOfTheWeek.frontmatter.category
                            )}`}
                            className="transition duration-300 bg-sameLight2 text-text border-borderHome/30 hover:bg-borderHome hover:text-text"
                          >
                            {postOfTheWeek.frontmatter.category}
                          </Link>

                          <div className="text-text corner left">
                            {/* prettier-ignore */}
                            <svg width="101" height="101" viewBox="0 0 101 101" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M101 0H0V101H1C1 45.7715 45.7715 1 101 1V0Z" fill="f0ebff"></path></svg>
                          </div>
                          <div className="text-text corner bottom">
                            {/* prettier-ignore */}
                            <svg width="101" height="101" viewBox="0 0 101 101" fill="none" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M101 0H0V101H1C1 45.7715 45.7715 1 101 1V0Z" fill="f0ebff"></path></svg>
                          </div>
                        </span>
                  ...
                  <div className="md:col-6 text-center md:text-start">
                    <div className="post-card post-category-top group relative has-line-link-white text-text">
                      ...
                      <h3 className="text-2xl text-text leading-relaxed">
                        <Link
                      ...
                      <ul className="flex justify-center md:justify-start flex-wrap items-center gap-3 gap-y-1 uppercase text-sm my-6 text-text">
                        <li className="flex items-center">
                          <Image
                            ...
                            height={24}
                            width={24}
                            className="h-6 w-6 border border-text rounded-full mr-2 bg-white/10"
                          />
                      ...
                      <Link
                        href={postOfTheWeek.slug}
                        className="inline-block text-text group-hover:text-black group-hover:rotate-45 transition duration-300"
                        aria-label={`Read More about ${postOfTheWeek.frontmatter.title}`}
                      >
                        {/* prettier-ignore */}
                        <span className="h-12 w-12 flex items-center justify-center text-black bg-black/20 rounded-full has-transition">
